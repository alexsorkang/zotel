  ...
  cal.init({
    ...
    onClick: function(date, count) {
      ...
      if (count !== null && switchcase === 0) {
        ...
        window.setTimeout(function(){cal.update('getData1')}, 600);
        // }
      } else {
        if (switchcase === 0) {
        startdate = date;
        ...
        // if (r2 === true) {
          ...
          url: '/addevent',
          type: 'POST',
          data: {startdate: startdate, enddate: enddate, id: '556f49cf70969dcf017d8025', user: $('input[name=\'name\']:checked').val(), type: 1},
          dataType: 'json'
          });
          window.setTimeout(function(){cal.update('getData1')}, 600);
        // }
